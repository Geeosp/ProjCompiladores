...
public class ManuIpTest {
 ...
 @Test
  public void testSalada() throws IOException, WalaException,
    ...
    SimpleGraph sg = depend.Main.analyze(geeoip, "fachada", strCompUnit,
        line);
 ...
 public void testInserirLivro() throws IOException, WalaException,
   ...
   SimpleGraph sg = depend.Main.analyze(geeoip, "negocios", strCompUnit,
       line);
   System.out.println(sg.toDotString());
   String expectedResultFile = TEST_DIR + SEP
